...
public class doser_komatsud21 extends AppCompatActivity {
    ...
    private void setCekstok(){
        ...
        String inisial = "doser_comatsu21";
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    try {
                        ...
                        Toast.makeText(doser_komatsud21.this, "Eror saat: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(doser_komatsud21.this, "EROR", Toast.LENGTH_SHORT).show();
            }
        });
    }
